...
################################################################################
#COMPARE ENGINEERED CODONS TO VACINE CODONS
################################################################################

percentage_accuracy =compare(engineered_virus_codons,vacine_codons)

print("The program outputs a sequence that is",percentage_accuracy,"the same as the vaccine")
